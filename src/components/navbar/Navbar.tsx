    ...
    <div className="flex justify-between items-center h-24 border border-b-2">
      ...
      <div className="hidden md:flex w-[50%]">
        <div className="flex gap-9 text-gray-600 px-6 items-center ">
          ...
          <div className="md:hidden lg:flex w-[26rem] h-7 ml-5 flex justify-center items-center relative">
      ...
      {/* right */}
      <div className="flex w-[30%] justify-end items-center gap-4 mr-2 pr-3">
        <MobileMenu />
      </div>
    </div>
  );
